...
class Admin extends CI_Controller {
	...
	public function migrantes() {
		...
		/*Denuncia*/
		$crud->db->select('id_migrante, nombre, id_pais, id_estado, municipio, id_genero, edad, fecha_nacimiento, ocupacion, id_estado_civil, escolaridad, pueblo_indigena, nombre_pueblo_indigena, espanol, id_lugar_denuncia, denuncias.id_denuncia');
